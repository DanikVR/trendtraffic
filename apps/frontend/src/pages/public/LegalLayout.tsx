...
const LEGAL_STYLES = `
.legal h2 { font-family: 'Space Grotesk', sans-serif; font-weight: 700; font-size: 1.35rem; color:#fff; margin-top: 2.6rem; margin-bottom: 0.2rem; scroll-margin-top: 5rem; }
...
.legal a  { color: #ff8a2b; text-decoration: none; }
    ...
    <div className="dark relative min-h-screen text-white" style={{ background: '#0A0A0B' }}>
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-14">
        <div className="flex items-center gap-3 mb-5">
          <span className="h-px w-8" style={{ background: 'rgba(255,115,0,0.6)' }} />
        ...
        <div className="mt-12 pt-6 text-sm text-white/45" style={{ borderTop: '1px solid rgba(255,255,255,0.08)' }}>
          По всем вопросам: <a href="mailto:SEO@vibevox.pro" style={{ color: '#ff8a2b' }}>SEO@vibevox.pro</a>
        </div>
      </main>
