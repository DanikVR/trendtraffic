...
const ARTICLES: WikiArticleMeta[] = [
  {
    ...
    sections: [
      { id: 'intro', open: ES },
      { id: 'api', tab: 'API', image: '/wiki/api.png', open: `${ES}?section=gemini`, keyHref: 'https://aistudio.google.com/app/apikey' },
      { id: 'mcp', tab: 'MCP', image: '/wiki/mcp.png', open: `${ES}?section=mcp` },
      { id: 'tikhub', tab: 'Tikhub', image: '/wiki/tikhub.png', open: `${ES}?section=tikhub`, keyHref: 'https://tikhub.io' },
      { id: 'generation', tab: 'Generation', image: '/wiki/generation.png', open: `${ES}?section=openmontage` },
